...
Esperanto, kiun notlibro povas instali kaj uzi en kelkaj linioj.
...
| **Pako** | *Dosierujo* de moduloj kun `__init__.py`, importata kiel unu unuo. |
...
- **Reuzon.** Verku la Esperantan tokenizilon unufoje; importu ĝin de ĉiu notlibro,
...
- **Distribuadon.** Unu sola komando `pip install` liveras la kodon kaj ĝiajn
  dependecojn al iu ajn, ie ajn — inkluzive de notlibro en Google Colab.
