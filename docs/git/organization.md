...
The hash is worth a second look. It is derived from the commit's content, so it
is effectively unique and it *cannot* be forged: if a single byte of history
