...
!!! warning "Kelkaj el ĉi tiuj forĵetas laboron"
    ...
    `git reset --hard`) **konstante forigas** tiujn ŝanĝojn: ili neniam estis
...
| `--mixed` *(defaŭlta)* | retroiras | rekomencigas | konserviĝas |
| `--hard` | retroiras | rekomencigas | **forĵetiĝas** |
