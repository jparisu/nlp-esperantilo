...
tiel, ke `main` ne povu esti rompita hazarde, kaj ke ĉiu ŝanĝo trairu revizititan,
...
## Protekto de branĉoj kaj rulsets

Defaŭlte, iu ajn kun skriba aliro povas puŝi rekte al `main`. **Ruleto (ruleset)**
