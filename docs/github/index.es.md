...
- [**2. Primeros pasos**](first-steps.md) — cuenta, repositorio, issues, pull requests.
- [**3. Flujo de trabajo**](workflow.md) — el ciclo Git + GitHub del día a día.
- [**4. GitHub Actions**](actions.md) — pruebas, documentación y ortografía automatizadas.
- [**5. Configuración del repositorio**](repository-configuration.md) — proteger `main`.
- [**6. GitHub Pages**](pages.md) — publicar esta documentación.
