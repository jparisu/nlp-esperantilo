...
Kiam biblioteko estas pakita ([Organizado](organization.md)), por uzi ĝin sufiĉas unu
`pip install`. Ĉar la plej granda parto de la laboro en ĉi tiu kurso okazas en
**kajeroj (Google Colab)**, la ĉefa vojo estas instali rekte de GitHub — sen loka
...
En Colab-kajero, instalu en ĉelo (la komenca `!` rulas ŝelan komandon), poste
...
!!! note "Restartigu la rultempon post la instalado"
    Se vi jam importis `esperantilo`-n en kajero kaj poste instalas novan version,
