...
- [**2. First steps**](first-steps.md) — account, repository, issues, pull requests.
- [**3. Workflow**](workflow.md) — the day-to-day Git + GitHub cycle.
- [**4. GitHub Actions**](actions.md) — automated tests, docs and spell checking.
- [**5. Repository configuration**](repository-configuration.md) — protecting `main`.
- [**6. GitHub Pages**](pages.md) — publishing this documentation.
